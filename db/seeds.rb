...
User.create!(email: "user1@user.com", password: "password", first_name: "Kiera", last_name: "Hour-Uoy", nickname: "Wild Child", cred:10 )
User.create!(email: "user2@user.com", password: "password", first_name: "Ian", last_name: "Taylor", nickname: "PetMeister", cred:100 )
