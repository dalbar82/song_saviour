...
User.create!(email: "user3@user.com", password: "password" )
User.create!(email: "user4@user.com", password: "password" )
User.create!(email: "user5@user.com", password: "password" )
User.create!(email: "user6@user.com", password: "password" )
User.create!(email: "user7@user.com", password: "password" )
