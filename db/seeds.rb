...
User.create!(email: "user1@user.com", password: "password", first_name: "Kiera", last_name: "Hour-Uoy" )
User.create!(email: "user2@user.com", password: "password", first_name: "Ian", last_name: "Taylor" )
User.create!(email: "user3@user.com", password: "password", first_name: "Angus", last_name: "Williamson" )
User.create!(email: "user4@user.com", password: "password", first_name: "Akash", last_name: "Chhetri" )
User.create!(email: "user5@user.com", password: "password", first_name: "Thembisile", last_name: "Baleni" )
User.create!(email: "user6@user.com", password: "password", first_name: "Meredith", last_name: "MacAulay" )
User.create!(email: "user7@user.com", password: "password", first_name: "Damion", last_name: "Lonel" )
